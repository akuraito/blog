...
categories: ["toss"]
images: ["posts/hello-world-2/og.png"]
---
...
![vim-full-use](vim-full-use.webp)

相信你也是不会没事用 vim 在屏幕输入设备上打字的人，所以我们需要记住的就只有下面这一张：

![vim-vi-workmodel](vim-vi-workmodel.webp)
...
![hexo-build](hexo-build.webp)

### Front-matter

打开名为 1 文章之后，里面会含有这样的一串字符

![vim-post-edit](vim-post-edit.webp)
...
![vim-post-edited](vim-post-edited.webp)
...
![purewrite-picshort-markdown-heads](heads.webp)
...
![hexo-next-readmore](hexo-next-readmore.webp)
