...
categories: ["toss"]
images: ["posts/hello-world/og.png"]
---
...
点击这个![复制按钮:radio_button:](11.webp)
...
![edited README](14.webp)

点击上方的`settings`进入仓库设置。

![GitHub Settings](15.webp)

向下滑找到`GitHub Pages`。

![GitHub Pages setting](16.webp)

点击`none`，然后选择`master branch`。

![branch setting](17.webp)
