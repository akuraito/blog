...
![The Boys](/images/bangumi-2020/the-boys.webp)
...
![宝石商リチャード氏の謎鑑定](/images/bangumi-2020/jeweler-richard.webp)
...
图片采用 `og:image` 或 `twitter:image` 等公开图片并压缩为 80% 的 webp 文件。 ~~之后会再改，比如 Netflix 的图是真的诡异。~~ 更新完成。有网站的从网站扒，没网站的从豆瓣扒，部分还用了微博。具体参见 [bangumi-2020.csv](/forms/bangumi-2020.csv)。
